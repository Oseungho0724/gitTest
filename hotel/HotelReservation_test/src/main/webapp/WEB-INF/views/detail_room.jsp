					...
					<c:if test="${nowUser == id_hotel }">
						<tr class="table-success">
							<td colspan=4><a
								...
								class="btn btn-outline-primary">방 정보 수정 </a> <a
								href="delete_room?detailAddr_roomNum_room=${roomvo.detailAddr_roomNum_room }"
								class="btn btn-outline-primary">방 정보 삭제 </a></td>
						</tr>
					</c:if>
					<c:if test="${nowUser != '비회원' }">
						<c:if test="${nowUser != id_hotel }">
							<tr class="table-success">
								...
								<td colspan=4>
									<a href="reservation?detailAddr_roomNum_room=${roomvo.detailAddr_roomNum_room }&id_hotel=${id_hotel}&checkIn=${checkIn}&checkOut=${checkOut}" 
									   class="btn btn-outline-primary">방 예약</a>
								</td>
								</c:if>
							</tr>
						</c:if>
