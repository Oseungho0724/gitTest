		...
		<div class="row">
			<div class="col-md-8">
				...
				<form action="update_room_save" method="post"
					...
					<input type="hidden" name="detailAddr_room" value="${roomvo.detailAddr_room }">
					...
					<div class="input-group mb-3">
						<span class="input-group-text" id="basic-addon1">방 가격</span> <input
							type="text" class="form-control"
							aria-label="Username" aria-describedby="basic-addon1"
							name="price_room" value="${roomvo.price_room }">
					</div>
					<div class="input-group mb-3">
						<span class="input-group-text" id="basic-addon1">체크 인</span> <input
							type="time" class="form-control" placeholder="숙소 명"
							aria-label="Username" aria-describedby="basic-addon1"
							name="checkIn_room"  value="${roomvo.checkIn_room}" min="13:00:00" max="16:00:00">
					</div>
					<div class="input-group mb-3">
						<span class="input-group-text" id="basic-addon1">체크 아웃</span> <input
							type="time" class="form-control" placeholder="숙소 명"
							aria-label="Username" aria-describedby="basic-addon1"
							name="checkOut_room"  value="${roomvo.checkOut_room}" min="11:00:00" max="12:00:00">
