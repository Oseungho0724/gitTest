				...
				<table border=2 style="width:768px" class="table-dark table table-striped">
					...
					<c:forEach var="hvo" items="${hotelList}">
						...
						<tr class="table-success">
							<td colspan=2 class="table-success"><a
								href="detail_hotel?detailAddr_hotel=${hvo.detailAddr_hotel}&id_hotel=${hvo.id_hotel}">
									<img src="download?filename=${hvo.img_hotel}" width=400
									height=250 style=" object-fit:fill;">
							</a></td>

							<td colspan=2>숙소 이름 : ${hvo.name_hotel }<br>
								위치 : ${hvo.bigAddr_hotel } ${hvo.detailAddr_hotel }
							</td>
						</tr>
					</c:forEach>
				</table>
